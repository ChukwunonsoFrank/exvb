<div class="hidden lg:flex flex-none flex-col items-center space-y-3 w-16 lg:border-r lg:border-[#26252a]">
    <div @class([
        ...
        <a class="block" href="{{ route('dashboard') }}">
            ...
            <div class="text-center">
                <p class="text-[9px] font-semibold tracking-wide {{ request()->is('dashboard') ? 'text-white' : 'text-[#a4a4a4]' }}">
                    Chart</p>
            </div>
        </a>
    </div>
        ...
        <a class="block" href="{{ route('dashboard.history') }}">
            <div class="mb-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    class="block mx-auto icon icon-tabler icons-tabler-outline icon-tabler-history-toggle">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    <div @class([
        ...
        <a class="block" wire:click="robot()">
            <div class="mb-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="block mx-auto" width="24" height="24"
