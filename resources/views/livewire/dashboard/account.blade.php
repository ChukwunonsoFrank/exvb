        ...
        <div class="lg:h-full lg:flex-1 lg:px-96 lg:pt-6">
            ...
            <div class="py-2 lg:h-full lg:pb-24 lg:overflow-scroll scrollbar-hide">
                        ...
                        <div class="text-start grow">
                            ...
                            <div class="flex items-center gap-x-2 mb-2">
                                <div class="grow">
                                    ...
                                    @if ($this->kycStatus === 'Verified')
                                        <div
                                            class="px-1.5 py-0.5 cursor-pointer inline-flex items-center border border-red-500 justify-center gap-x-1 text-[10px] rounded-lg">
                                            <span class="text-red-500 font-bold mt-0.5">Verified</span>
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-4">
                    ...
                    <a class="cursor-pointer" x-on:click="$store.accountPage.toggleDeleteAccountModal();">
                        <div
                            class="bg-dim w-full rounded-lg flex items-center space-x-2 p-3 mb-1 border border-[#323335] lg:mb-0">
            ...
            <div x-cloak x-show="$store.accountPage.isProfilePictureModalOpen"
            ...
            <div x-cloak x-show="$store.accountPage.isDeleteAccountModalOpen"
                class="fixed top-0 left-0 h-svh w-full px-4 lg:px-96 pt-6 z-20">
                <div class="absolute inset-0 h-svh w-full px-4 lg:px-96 pt-6 z-20 bg-dashboard opacity-85"></div>
                <div class="relative w-full h-full flex items-center justify-center z-30">
                    <div
                        ...
                        <div class="p-6 overflow-y-auto text-center">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-y-2">
                                ...
                                <div>
                                    <button x-on:click="$store.accountPage.toggleDeleteAccountModal();" type="button"
