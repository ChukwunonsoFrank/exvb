            ...
            <div
                ...
                <div class="flex-none text-end py-3">
                    <a href="{{ route('dashboard.deposit') }}">
                        <button type="button"
                            class="px-4 py-3.5 lg:px-10 inline-flex items-center gap-x-0.5 text-[13px] font-semibold tracking-[0.15px] rounded-md bg-accent text-white focus:outline-hidden">
