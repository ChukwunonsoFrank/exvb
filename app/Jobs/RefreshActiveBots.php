            ...
            ->chunk(100, function ($bots) {
                foreach ($bots as $bot) {
                    ...
                    if ($now > $endDate) {
                        ...
                        if ($accountType === "demo") {
                            ...
                            DB::transaction(function () use (
                                ...
                                User::where("id", $bot->user->id)->update([
                    ...
                    if ($now > $checkpoint) {
                        ...
                        $newCheckpoint = Carbon::createFromTimestampMs(
                            $checkpoint,
                        )
                            ->addMinutes(5)
                            ->addSeconds(8)
                        ...
                        $profit = json_decode($bot["profit_values"])[
                            $profitPosition
                        ];
                        $updatedTotalProfit =
                            $this->normalizeAmount($bot["profit"]) + $profit;
        ...
        try {
            ...
            if ($level === 1) {
                ...
                $newFirstUplineBalance =
                    $firstUpline["live_balance"] + $commission;
                ...
                DB::transaction(function () use (
                    ...
                    User::where("id", $firstUpline["id"])->update([
            ...
            if ($level === 2) {
                ...
                $newSecondUplineBalance =
                    $secondUpline["live_balance"] + $commission;
                ...
                DB::transaction(function () use (
                    ...
                    User::where("id", $secondUpline["id"])->update([
